    ...
    <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        ...
        <div className="mb-5 lg:w-1/3 lg:mb-0 lg:mr-20">
          <h2 className="relative mb-4 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
            <span className="relative inline-block">
              ...
              <span className="relative">A Trivia Cloud Platform</span>
            </span>{' '}
            for The Digital World!
          </h2>
          <p className="mb-4 text-gray-900 lg:mb-6">
            Advanced quiz builder that includes SETTINGS and QUESTIONS sections. Settings control WHAT, WHEN, FOR WHOM, and HOW the quiz will function.
          </p>
          <a
            href="/"
            aria-label=""
      ...
      <div className="">
        <img
          ...
          alt=""
        />
        <div className=" inset-0 bg-gray-900 bg-opacity-50" />
      </div>
    </div>
  );
};